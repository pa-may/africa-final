    ...
    <div>
      ...
      <div className="item">
        ...
        <div className="item__container-2">
          ...
          <div className="item__container-2__text">
            Normally delivered between 2 days after confirmation of your order date. Please check
           exact dates in the Checkout page.See more{" "}
          </div>
      ...
      <section className="latest-products">
        ...
        <div className="products-slidder">
          ...
          <div className="products-container">
            <img
              className="products-image"
              src="/img/checker-custard.png"
              alt=""
            />
            <h5 className="products-name">Checker custard</h5>
            <h6 className="products-price"> £6.99</h6>
            <button className="add-basket-btn">
              <a className="add-basket-text" href="">
                ADD TO BASKET
          ...
          <div className="products-container">
            <img
              ...
              alt=""
            />
            <h5 className="products-name">Gino tomatoe puree</h5>
            <h6 className="products-price"> £6.99</h6>
            <button className="add-basket-btn">
              <a className="add-basket-text" href="">
                ADD TO BASKET
          ...
          <div className="products-container">
            <img
              className="products-image"
              src="/img/golden-basmati.png"
              alt=""
            />
            <h5 className="products-name">Golden Basmati Rice</h5>
            <h6 className="products-price"> £6.99</h6>
            <button className="add-basket-btn">
              <a className="add-basket-text" href="">
                ADD TO BASKET
          ...
          <div className="products-container">
            <img
              ...
              alt=""
            />
            <h5 className="products-name">Indomie noodles</h5>
            <h6 className="products-price"> £6.99</h6>
            <button className="add-basket-btn">
              <a className="add-basket-text" href="">
                ADD TO BASKET
